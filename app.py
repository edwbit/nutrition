...
if prompt := st.chat_input("Type the vegetable or fruit name"):
    #task requirements
    task_requirements = f""" Provide the History, Scientific Name, Nutritional Facts and what it does to the body, Medicinal Properties, Diseases it can prevent or cure, Preparation and consumption, Filipino Recipes of of {prompt}"""
