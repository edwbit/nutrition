...
if prompt := st.chat_input("Type the vegetable or fruit name"):
    #task requirements
    task_requirements = f""" Provide the History, Scientific Name, Nutritional Facts with description, Medicinal Properties, Diseases it can prevent or cure, Glycemic index compared with white rice. Preparation and consumption of {prompt}"""
